    ...
    return (
      <nav id="navbar">
        ...
        <div id="cart-box">
          {currencyActive ? (
            <div>
              <CSwitcherWithApollo
                ...
                onClickOutside={() => { this.setState({ currencyActive: false }); }}
              />
            </div>
          ) : (
            <div />
          ...
          <button type="button" id="crcy-box" onClick={() => { this.toggleCurrency(); }}>
            <div id="crcy-sign">
          ...
          <button type="button" className="cart-btn" onClick={() => { this.toggleCart(); }}>
